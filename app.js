...
const server = http.createServer((req, res) => 
    ...
    if (req.method === 'GET' && req.url === '/posts')
        {
//ob die Mehtode GET gleich mit der URL ist und posts (was gespeichert wurde zb.let posts = [ ID1 und ID2 usw)
...
server.listen(port, hostname, () => {
    ...
    console.log(`Teste den GET / posts Endpunkt unter http://${hostname}:${port}/`);
});
